...
The first crucial move is making sure your [web app](https://rokimiftah.me) is prepped and ready to get tested on. The next step is to install k6 and Node.js depends on the operating system you are using.
